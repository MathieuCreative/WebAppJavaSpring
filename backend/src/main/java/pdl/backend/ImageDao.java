...
public class ImageDao implements Dao<Image> {
  ...
  public Optional<Image> retrieve(final long id) {
    Image arecup = images.get(id);
    return Optional.ofNullable(arecup);
  }

  @Override
  public List<Image> retrieveAll() {
    Collection<Image> collection_valeurs = images.values();
    List<Image> listeValeurs = new ArrayList<>(collection_valeurs);
    return listeValeurs;
  }
